...
<ul>
    <li> Osnivanje privrednih društava i preduzetnika</li>
    <li> Registracija promene podataka firme kod APR-a </li>
    <li> Promena pravne forme</li>
    <li> Izrada dokumentacije za registraciju firme kod poreske uprave pre otpočinjanja delatnosti</li>
    <li> Informisanje klijenta o aktuelnim poreskim zakonima</li>
    <li> Kontrola primljene poslovne dokumentacije – provera usaglašenosti sa važećim propisima</li>
    <li> Knjiženje poslovne dokumentacije u skladu sa Zakonom o računovodstvu</li>
    <li> Evidencija osnovnih sredstava i obračun troškova amortizacije</li>
    <li> Evidencija blagajničkog poslovanja</li>
    <li> Izrada svih obrazaca za prijavu i odjavu radnika</li>
    <li> Obračun zarada i naknada zarada za zaposlene</li>
    <li> Obračun naknade i poreza i doprinosa na ugovore sa fizičkim licima</li>
    <li> Popunjavanje i predaja PPP i M4 obrasca</li>
    <li> Vođenje knjige ulaznih i izlaznih računa</li>
    <li> Obračun PDV obaveze, izrada i predaja PDV prijave</li>
    <li> Obračun ostalih poreskih obaveza, izrada i predaja poreskih prijava elektronskim putem</li>
    <li> Izrada kalkulacija za velelirodaju, uvoz i izvoz</li>
    <li> Obračun službenih putovanja u zemlji i inostranstvu</li>
    <li> Priprema za završni račun, predzaključna knjiženja, izrada probnog bilansa</li>
    <li> Izvodi otvorenih stavki, usklađivanje knjigovodstvenog sa stvarnim stanjem</li>
    <li> Izrada završnog računa</li>
    <li> Druge usluge na zahtev klijenta</li>
</ul>
